...
(function () {
  var SP_BOOK_CATALOG = [
    ...
    { key: 'ov-0406', fba: 'FBA15HJ20260406', cust: 'ref-overdue-01', customer: '深圳星航供应链', cntr: 'TCLU5566778', sysNo: 'EXP-2026-0406', qty: '16', plt: '2', vol: '0.88', gw: '142', whIn: '2026-04-20', zt: 'ZT2604200001', pallets: ['PLT-LAX-501', 'PLT-LAX-502'], palletGroup: '', bookable: true, status: '待提货', pickCode: 'SP88A00Q' },
    ...
    { key: 's-0402a', fba: 'FBA15HJ20260402', cust: 'HK-2026-0402', customer: '深圳星航供应链', cntr: 'MSKU2234567', sysNo: 'EXP-2026-0402', qty: '8', plt: '1', vol: '0.85', gw: '120', whIn: '2026-04-26', zt: 'ZT2604260004', pallets: ['PLT-LAX-401'], palletGroup: '', bookable: true, status: '待提货', pickCode: 'SP88C92A' },
    { key: 's-0402b', fba: 'FBA15HJ20260402', cust: 'HK-2026-0402', customer: '深圳星航供应链', cntr: 'MSKU2234567', sysNo: 'EXP-2026-0402', qty: '14', plt: '2', vol: '1.10', gw: '168', whIn: '2026-04-26', zt: 'ZT2604260005', pallets: ['PLT-LAX-402'], palletGroup: '', bookable: true, status: '待提货', pickCode: 'SP88D92B' },
  ...
  function spBookSyncSessionRowsAppt(sess, appt) {
    ...
    if (appt && appt.date && appt.slot && (appt.status === '待提货' || appt.status === '已预约' || appt.status === '已过期')) {
      sess.rows = spBookPatchRowsAppt(sess.rows, {
        date: appt.date,
        slot: appt.slot,
        status: appt.status === '已过期' ? '已过期' : '待提货'
      });
      return sess;
    }
